...
![Screenshot](./assets/images/relogio.png)
...
Esse projeto foi desenvolvido para aprimorar minhas habilidades em front-end, principalmente na parte de JavaScript.

## 🏁 Instalação:

Antes de começar, é bom ter um editor para trabalhar com o código, como: [VSCode](https://code.visualstudio.com/). Clone este repositório usando git clone: https://github.com/otaviopdev/Relogio.git ou clique em Code/Download ZIP. Clique no arquivo "index.html" e veja a aplicação.
...
Este projeto está sob a licença MIT. Veja o arquivo [LICENSE](https://github.com/otaviopdev/Relogio/blob/main/LICENSE) para mais detalhes.
